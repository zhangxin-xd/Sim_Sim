...
class TestOptions(BaseOptions):
    def initialize(self):
        ...
        self.parser.add_argument("--multisepcific_dir", type=str, default='./demo_file/multispecific_ours', help="Dir for multi specific")
        self.parser.add_argument("--video_path", type=str, default='./test_sample/3dbe8314b86284eb.mp4', help="path for the video to swap")
        self.parser.add_argument("--temp_path", type=str, default='./temp_results', help="path to save temporarily images")
        self.parser.add_argument("--output_path", type=str, default='./output/3dbe8314b86284eb.mp4', help="results path")
        ...
        self.parser.add_argument('--start', type=float, default=0.2, help='start point of manipulation')
        self.parser.add_argument('--end', type=float, default=0.7, help='end point of manipulation')
